...
| [0038](0038-mobile-home-composes-plugin-read-models.md) | accepted | 移动首页组合插件只读投影 | HOME-001、WEBUI-001～006、MOB-005 |
...
| [1005](1005-drift-owns-observable-activities-and-artifacts.md) | accepted | Drift 拥有可观察活动与显式成果 | OBJ-002、STA-001/003、PRO-002、HOME-001～002 |
