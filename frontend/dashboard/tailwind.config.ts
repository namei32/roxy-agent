...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        bg: "rgb(var(--roxy-color-bg-canvas-rgb) / <alpha-value>)",
        surface: "rgb(var(--roxy-color-bg-surface-rgb) / <alpha-value>)",
        "surface-2": "rgb(var(--roxy-color-bg-surface-low-rgb) / <alpha-value>)",
        "surface-3": "rgb(var(--roxy-color-bg-surface-high-rgb) / <alpha-value>)",
        border: "var(--roxy-color-border-default)",
        "border-strong": "var(--roxy-color-border-strong)",
        fg: "rgb(var(--roxy-color-text-primary-rgb) / <alpha-value>)",
        muted: "rgb(var(--roxy-color-text-secondary-rgb) / <alpha-value>)",
        subtle: "rgb(var(--roxy-color-text-muted-rgb) / <alpha-value>)",
        accent: "rgb(var(--roxy-color-action-primary-rgb) / <alpha-value>)",
        "accent-ink": "rgb(var(--roxy-color-on-action-primary-rgb) / <alpha-value>)",
        "accent-soft": "var(--roxy-color-action-soft)",
        "accent-deep": "rgb(var(--roxy-color-action-hover-rgb) / <alpha-value>)",
        danger: "rgb(var(--roxy-color-status-error-rgb) / <alpha-value>)",
        warning: "rgb(var(--roxy-color-status-warning-rgb) / <alpha-value>)",
        success: "rgb(var(--roxy-color-status-success-rgb) / <alpha-value>)",
      },
      borderRadius: {
        xs: "1px",
        sm: "2px",
